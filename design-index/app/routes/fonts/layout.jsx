  ...
  return (
    <>
          ...
          <div className='flex flex-row items-start justify-start h-auto w-auto mt-[10px] ml-[5px]'>
            ...
            <Link to="/fonts/index.jsx" className='cursor-pointer flex h-auto w-auto py-[3px] px-[8px] lg:px-[10px] items-center justify-center font-Poppins font-bold text-[15px] md:text-[12px] lg:text-[14px] xl:text-[16px] 2xl:text-[20px] text-black bg-gray-200 ml-[10px] rounded-[10px]'>all</Link>
